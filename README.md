...
- **Grader: don't accept a substring that drops a distinguishing leading word.** Token-containment grading would likely accept "Spain" for "New Spain" (or "Korea" for "North Korea") as a near-match. The grader should treat a leading qualifier as significant so "New Spain" ≠ "Spain". (Surfaced in PR #1 review.)
